  ...
  return (
    <div className="-z-10 mt-10">
      <div className="">
        ...
        <h1 className="text-3xl text-center font-bold text-[#ffaa33] pb-5 px-9 uppercase space-x-2">
          ...
          {products.products?.length > 0 ? (
            ...
            <section className="items-center flex flex-col gap-5 justify-center h-[67vh] border">
              <img
                ...
                alt=""
              />
              <h1 className="font-bold text-xl text-black text-center flex items-center gap-2">
                Product Not Found For{" "}
                <p className="text-[#ff5f1f] flex gap-2 uppercase">
                  {" "}
                  {categoryId?.split("_").map((item) => (
                    <span className="text-[#8672ff]">{item}</span>
                  ))}{" "}
                </p>{" "}
              </h1>
            </section>
