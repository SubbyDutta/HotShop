        ...
        <div className='w-60 relative '>
            ...
            <div className='pt-3 space-y-1  rounded-md '>
                ...
                <div className=' flex items-center gap-3 '>
                    ...
                    <span className='text-[a738fc] font-semibold'>{item.discountPercent}% off</span>
                </div>
...
<div className='absolute top-1 right-1'>
     ...
     onClick={handleIconClick}
      >
 <CloseIcon className='cursor-pointer bg-white rounded-full p-1' sx={{ color: purple[600],fontSize:"2rem"  }} />
     </button>
