    ...
    return (
        <div className="rounded-lg">
            <div className="w-full lg:w-[40vw] h-[82vh] shadow-2xl bg-white z-50 rounded-lg">
                <div className=" h-[12%] flex justify-between items-center px-5 bg-slate-800 rounded-t-lg">
                    <div className="flex items-center gap-3 ">
                        <h1 className="font-audiowide text-3xl text-[#8672ff]">HotShop</h1>
                        <p className="text-white">Assitant</p>
                    </div>
                ...
                <div className="h-[78%] p-5 flex flex-col py-5 px-5 overflow-y-auto bg-slate-100  custom-scrollbar">

                    <p>welcome to HotShop Ai Assistant, you can
                ...
                <div className=" h-[10%] flex items-center bg-slate-800">
                    <input
                        onChange={handlePromptChange}
                        type="text"
                        placeholder="give your prompt"
                        className="rounded-bl-lg pl-5 h-full w-full bg-slate-800 text-white border-none outline-none"
                    />
                    <Button
                        sx={{ borderRadius: "0 0 0.5rem 0" }}
                        className="h-full bg-[#8672ff]"
