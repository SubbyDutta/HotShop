...
public class AuthServiceImpl implements AuthService {
    ...
    public void sentLoginOtp(String email) throws UserException, MessagingException {
        ...
        String subject = "Welcome to HotShop Sports — your one-stop shop for all things sporty!\n" +
                "Just enter your mobile number or email, and we’ll send you a One-Time Password (OTP) to quickly and securely log in or sign up.\n" +
                "\n" +
                "No passwords to remember.\n" +
                "No hassle.\n" +
                "Just fast, secure access to all your favorite sports gear. \uD83C\uDFC0\uD83D\uDC5F\uD83C\uDFCB\uFE0F\u200D♂\uFE0F";
